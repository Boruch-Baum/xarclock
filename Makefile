...
# ----------------------------------------------------------------------
# Makefile generated from "Imake.tmpl" and </tmp/IIf.6Ocu2n>
...
# operating system:  Linux 5.10.0-23-amd64 x86_64 [ELF] (5.10.0)
# libc:	(6.36.0)
# binutils:	(242)
...
LOCAL_LIBRARIES =  $(XAWLIB) $(XMULIBONLY) $(XTOOLLIB) $(XPMLIB) $(EXTRAXAWCLIENTLIBS) $(XLIB) -lm
